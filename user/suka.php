...
function tambahPeminjaman($conn, $BukuID, $Judul, $Penulis, $Penerbit)
{

    $query = "INSERT INTO peminjaman (BukuID, Judul, Penulis, Penerbit)
              VALUES ('$BukuID', '$Judul', '$Penulis', '$Penerbit')";
...
if (isset($_POST['pinjam'])) {
    tambahPeminjaman($conn, $BukuID, $Judul, $Penulis, $Penerbit);
}
...
// Fungsi untuk menghitung rata-rata nilai rating
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="suka.php" class="btn btn-secondary">Sukai</a>
