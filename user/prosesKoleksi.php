...
function tambahUlasanBuku($conn, $Judul, $Ulasan, $rating)
{
    $query = "INSERT INTO ulasanbuku (Judul, Ulasan, Rating) VALUES ('$Judul', '$Ulasan', '$rating')";
    mysqli_query($conn, $query);
}

function hitungRataRataRating($conn, $query)
{
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post">
                            <button type="submit" name="submit_koleksi" class="btn btn-primary" ><a href="proses_koleksi.php?id_buku=<?= $id; ?>" style="color:  white;">Koleksi</a></button>
                        </form>
