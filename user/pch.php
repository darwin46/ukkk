...
if (isset($_GET['cari'])) {
    ...
    $query = "SELECT * FROM buku WHERE BukuID LIKE '%$pencaharian%' OR Judul LIKE '%$pencaharian%' OR Status LIKE '%$pencaharian%' ORDER BY BukuID ASC";
} else {
...
<body>
            ...
            <tbody class="tbl">
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $Deskripsi; ?></td>
                        <td><button class="btn btn-sm btn-primary" onclick="window.location.href='prosesKoleksi.php?BukuID=<?= $BukuID; ?>'">Koleksi</button>
                        <td><button onclick="goToPinjamPage(<?= $BukuID; ?>)">Buka</button></td>
                    </tr>
                <?php
                }
                ?>
    ...
    <script>
        function goToPinjamPage(BukuID) {
            window.location.href = 'pinjam.php?id_buku=' + BukuID;
        }
    </script>
