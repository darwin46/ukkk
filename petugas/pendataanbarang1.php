...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="d-flex align-items-center ms-auto">
                    ...
                    <div class="ms-2">
                        <button class="btn btn-primary" onclick="window.location.href='buatlaporan1.php'">Buat Laporan</button>
                        <button class="btn1" onclick="window.location.href='pendataanbarang1.php'">Pendataan Barang</button>
                        <button class="btn btn-primary" onclick="window.location.href='dataanggota1.php'">Data Anggota</button>
    ...
    <div class="container">
        <form method="GET" action="pendataanbarang1.php">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-right: 20px; margin-left: 20px;">
            <button type="submit" class="btn btn-primary" onclick="window.location.href='tambahbuku1.html'">Tambah Barang</button>
            <div class="dropdown-container">
                <div style="display: flex; align-items: center;">
                    ...
                    <button class="btn btn-primary ms-2" onclick="window.location.href='tambahKategori1.php'">Tambah Kategori</button>
                </div>
            </div>
        </div>
