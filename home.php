    ...
    <div>
        <div class=" container">
            <div class="text-content">
                ...
                <p>Menghadirkan opsi membaca secara online dengan akses instan atau pilihan membaca
                    jangka panjang,
                    perpustakaan digital kami menyediakan berbagai cara untuk memenuhi kebutuhan
                    literasi pengguna.
                    menjadikan pengalaman perpustakaan digital lebih efisien dan nyaman.</p>
                <button class="btn btn-primary" onclick="window.location.href='pch.php';">Cari Buku
                </button>
            </div>
